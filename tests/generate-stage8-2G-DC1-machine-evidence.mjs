...
const copied = ['effect_inventory', 'muzzle_effect_check', 'impact_effect_check', 'damage_visual_check', 'destruction_effect_check', 'wreck_effect_check', 'camera_feedback_check', 'transition_check', 'audio_cue_check', 'semantic_resolution', 'determinism_check', 'authority_check', 'performance_check'];
