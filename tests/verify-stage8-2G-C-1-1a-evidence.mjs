...
for (const frame of machineFrames) {
  ...
  const expectedSpecs = buildProductionDrawSpecs({ actors: state.actors, wrecks: state.wrecks, environment: state.environment, camera: state.camera, options: { battlefieldBounds: presentation.plan.layout.bounds, viewport: frame.screenMetrics.viewport } });
