...
const answers = [
  ...
  { id: 6, question: 'migration', answer: `SAVE_VERSION=${SAVE_VERSION}; missing equipment uses emptyEquipmentState`, verified: SAVE_VERSION === 8 && save.includes('emptyEquipmentState()') },
