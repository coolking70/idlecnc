...
export function buildVictoryPresentationPlan(contract, options = {}) {
  ...
  const plan = {
    ...
    sourceId, sourceKind: options.sourceKind || 'formal_runtime_report', rebuildHash: options.rebuildHash || null, reportId: contract.normalizedBattle.battle.id, seed: contract.normalizedBattle.battle.seed,
